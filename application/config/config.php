...
// $config['sess_driver'] = 'files'; // Mécanisme de stockage de session (par exemple : files, database, redis, etc.)
// $config['sess_cookie_name'] = 'ci_session'; // Nom du cookie de session
// $config['sess_expiration'] = 7200; // Durée d'expiration de la session en secondes
// $config['sess_save_path'] = APPPATH . 'cache/sessions/'; // Chemin où les fichiers de session sont stockés (pour le stockage par fichiers)
// $config['sess_match_ip'] = FALSE; // Correspondre à l'adresse IP du client lors de la récupération des données de session
// $config['sess_time_to_update'] = 300; // Fréquence de mise à jour de la session
// $config['sess_regenerate_destroy'] = FALSE; // Régénérer l'identifiant de session à chaque requête
