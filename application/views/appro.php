                    ...
                    <?php if (isset($_SESSION['let_test']) && !$_SESSION['let_test']) : ?>
                        ...
                        <?php else : ?>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-4">
                                    <label class="form-label">Budgets à utiliser :</label>
                                    <button type="button" class="btn btn-info w-100" id="select_budget">
                                        <i class="fas fa-dollar-sign"></i> Choisir budgets
                                    </button>
                                    <input type="hidden" name="idbudget" id="idbudget" value="">
                                </div>
                            </div>
                            <!-- Conteneur des budgets sélectionnés -->
                            <div id="budget_container" class="mb-3 p-2 border rounded" style="min-height: 50px; background: #f8f9fa;"></div>
                            <div class="mb-2">
...
<!-- Modal pour sélection des budgets (en dehors du formulaire) -->
<div class="modal fade" id="mybudgetmodal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Sélectionner les budgets</h4>
                <button type="button" class="btn-close close_budget" data-bs-dismiss="modal">
...
<!-- Bouton caché pour ouvrir le modal -->
<!-- <button type="button" id="active_buget_modal" data-bs-toggle="modal" data-bs-target="#mybudgetmodal" style="display:none;"></button> -->
