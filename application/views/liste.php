        ...
        <div class="corps">
            <div class="stock_corps">
                ...
                <div class="onglet">
                    ...
                    <a href="<?= base_url('liste') ?>" class="onglet_btn active">Liste des matériels distribués</a>
                    <a href="<?= base_url('beneficiaire') ?>" class="onglet_btn">Bénéficiaire</a>
                </div>
                <form action="<?= base_url('Liste/search') ?>" method="post" class="mb-4 " id="searchform">
                    <!-- <div class="row"> -->
                        ...
                        <tbody class="search-results">
                            ...
                            <?php for ($i = 0; $i < count($data); $i++) : ?>
                                <tr>
                                    ...
                                    <td><?= ($data[$i]->nombene == '') ? '--' :  $data[$i]->nombene  ?></td>
                                    <td><?= ($data[$i]->telbene == '') ? '...' :  $data[$i]->telbene  ?></td>
                                ...
                                <ul class="pagination justify-content-center pagination-sm">
                                    <li class="page-item">
                                        ...
                                        <?php else :  ?>
                                            <?php if (isset($_POST['date_debut'])) :  ?>
                                                ...
                                                <form action="<?= base_url('Liste/search/' . ($current - 1)) ?>" method="post">
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href='<?= base_url('Liste/page/' . ($current - 1)) ?>' aria-label="Previous">
                                                    <span aria-hidden="true"><i class="fa-solid fa-angle-left"></i></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    ...
                                    <?php for ($i = 1; $i <= $nPages; $i++) :  ?>
                                        <li class="page-item <?= ($i == $current) ? 'active'  :  '' ?>">
                                            <?php if (isset($_POST['date_debut'])) :  ?>
                                                <form action="<?= base_url('Liste/search/' . ($i)) ?>" method="post">
                                                    <div class="row d-none">
                                                        <div class="col-4 row">
                                                            <label for="date_debut" class="form-label">Date de début : </label>
                                                            <div class="input-group  mb-3">
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href="<?= base_url('Liste/page/' . $i) ?>"><?= $i ?></a>
                                            <?php endif; ?>
                                        </li>
                                    <?php endfor; ?>
                                    ...
                                    <li>
                                        ...
                                        <?php else :  ?>
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href="<?= base_url('Liste/page/' . ($current + 1)) ?>" aria-label="Next">
                                                    <span aria-hidden="true"><i class="fa-solid fa-angle-right"></i></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
