    ...
    <div class="wrapper">
        <div class="corps">
            <div class="stock_corps">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('Dashtuto/modifier/fr') ?>" id="modifClient" method="post" enctype="multipart/form-data">
                                    <div class="pb-2">
                                    ...
                                    <div class="pb-2">
                                        ...
                                        <input type="file" onchange="afficheVideoModif( this)" class="form-control" name="video">
                                    </div>
                                    <div class="_boutton">
                ...
                <div class="onglet">
                    <a href="<?= base_url('Admin/tutMal') ?>" class="onglet_btn ">Malagasy</a>
                    <a href="#" id="panier_" class="onglet_btn active">Français </a>
                </div>
                ...
                <div id="formulaire_video">
                    <form action="<?= base_url('Dashtuto/register/fr') ?>" method="post" id="form_video" enctype="multipart/form-data">
                        <h5>Ajouter</h5>
                        <div class="pb-2">
                            <label for="titre" class="form-label">Titre : </label>
                        ...
                        <div class="pb-2">
                            <label for="video" class="form-label">Video : </label>
                            <input type="file" onchange="afficheVideo( this)" class="form-control" name="video" required>
                        </div>
                        <div class="_boutton">
                ...
                <div class="titre">
                    ...
                    <div class="recherche">
                        <form action="<?= base_url('Dashtuto/search/1/fr') ?>" method="post">
                ...
                <ul class="video-list">
                    <?php if (isset($tutos)) : ?>
                        <?php foreach ($tutos as $key => $tuto) : ?>
                            <li class="video-item">
                                <video controls>
                                    <source src="<?= base_url($tuto->video) ?>" type="video/mp4">
                                    Votre navigateur ne supporte pas la balise vidéo.
                                </video>
                                <div class="video-info">
                                    <div class="video-title">Titre : <?= $tuto->titre ?></div>
                                    <div class="video-description">Tuto N° : <?= $tuto->numero ?> </div>
                                    <div class="video-language">Langue : <?= $tuto->langue ?></div>
                                </div>
                                <div class="video-controls">
                                    <button class="btn btn-outline-primary btn-custom editer" data-toggle="modal" data-target="#editModal" title="Modifier" data-title="<?= $tuto->titre ?>" data-num="<?= $tuto->numero ?>" data-langue="<?= $tuto->langue ?>" data-src="<?= $tuto->video ?>" data-id='<?= $tuto->idtuto ?>'><i class="fas fa-edit"></i></button>
                            ...
                            <ul class="pagination justify-content-center pagination-sm">
                                <li class="page-item">
                                    ...
                                    <?php else :  ?>
                                        <?php if (isset($_POST['query'])) :  ?>
                                            ...
                                            <form action="<?= base_url('Dashtuto/search/' . ($current - 1)) .'/fr' ?>" method="post">
                                        ...
                                        <?php else :  ?>
                                            <a class="page-link" href='<?= base_url('Dashtuto/page/'. ($current - 1)) .'/fr' ?>' aria-label="Previous">
                                                <span aria-hidden="true"><i class="fa-solid fa-angle-left"></i></span>
                                            </a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                ...
                                <?php for ($i = 1; $i <= $nPages; $i++) :  ?>
                                    <li class="page-item <?= ($i == $current) ? 'active'  :  '' ?>">
                                        <?php if (isset($_POST['query'])) :  ?>
                                            <form action="<?= base_url('Dashtuto/search/' . ($i)) .'/fr'?>" method="post">
                                                <input type="hidden" name="query" value="<?= $_POST['query'] ?? "" ?>">
                                        ...
                                        <?php else :  ?>
                                            <a class="page-link" href="<?= base_url('Dashtuto/page/' . $i .'/fr') ?>"><?= $i ?></a>
                                        <?php endif; ?>
                                    </li>
                                <?php endfor; ?>
                                ...
                                <li>
                                    ...
                                    <?php else :  ?>
                                        ...
                                        <?php else :  ?>
                                            <a class="page-link" href="<?= base_url('Dashtuto/page/' . ($current + 1)) .'/fr'?>" aria-label="Next">
                                                <span aria-hidden="true"><i class="fa-solid fa-angle-right"></i></span>
                                            </a>
                                        <?php endif; ?>
                                    <?php endif; ?>
