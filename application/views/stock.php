        ...
        <div class="corps">
            <div class="stock_corps">
                ...
                <?php if (can_manage('logistique')) : ?>
                    <div class="mt-4">
                        <form action="<?= base_url('Stock/search') ?>" method="GET">
                ...
                <div class="entete">
                    ...
                    <?php if (can_manage('logistique')) : ?>
                        <div class="">
                            <a href="<?= base_url('Stock-seuil') ?>" type="button" class="btn btn-warning">
                                <i class="fas fa-eye"></i>
                                Stock alert
                            </a>
                            <a href="<?= base_url('Stock-all') ?>" type="button" class="btn btn-info">
                                <i class="fas fa-eye"></i>
                                Tous les dépôts
                            </a>
                            <a href="<?= base_url('ExportationExel/stock') ?>" type="button" class="btn btn-success">
                            ...
                            <tr class="to_filtre">
                                <th>
                                    <div class="container_filter">
                                        <span>Réference</span>
                                        <form action="<?= base_url('filtre') ?> " method="get">
