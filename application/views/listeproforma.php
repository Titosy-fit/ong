            ...
            <div class="stock_corps">
                ...
                <div class="modal fade" id="showDetails" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel">Détails</h5>
                            </div>
                            <div class="modal-body" id="tab">
                ...
                <div class="modal fade" id="modalfacture">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title dispatch">Facture proforma </h4>
                ...
                <div class="onglet">
                    <a href="<?= base_url('proforma') ?>" class="onglet_btn "> Proforma </a>
                    <a href="#" id="panier_" class="onglet_btn active">Liste</a>
                </div>


                <form action="<?= base_url('Listeproforma/search') ?>" method="post" class="mb-4 " id="searchform">
                    <!-- <div class="row"> -->
                        ...
                        <tbody class="search-results">
                            ...
                            <?php for ($i = 0; $i < count($data); $i++) : ?>
                                <tr>
                                    ...
                                    <td><?= ($data[$i]->montant_total != '') ? number_three($data[$i]->montant_total) : '0 Ar' ?></td>
                                    <td><?= ($data[$i]->montant_payer != '') ? number_three($data[$i]->montant_payer) : '0 Ar' ?></td>
                                    <td><?= ($data[$i]->nomClient == '') ? (($data[$i]->r_social == '') ? '...' :  $data[$i]->r_social)  :  $data[$i]->nomClient  ?></td>

                                    <td><?= $data[$i]->prenomUser ?? 'Admin' ?></td>
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#showDetails" class="btn btn-secondary detail" data-idproforma="<?= $data[$i]->idproforma ?>" data-num="<?= $data[$i]->telClient ?>"><i class="fas fa-list"></i></a>

                                        <?php if ($_SESSION['user_type'] == 'admin') : ?>
                                            <a href="#" data-idproforma='<?= $data[$i]->idproforma ?>' class="btn btn-danger supprimer"><i class="fa-solid fa-trash"></i></a>
                                        <?php endif; ?>

                                        <!-- <a  class="btn btn-primary imprim">Imprimer</a> -->
                                        <button data-idproforma='<?= $data[$i]->idproforma ?>' data-Facture='<?= $data[$i]->Facture ?>' class="btn btn-primary imprim"><i class="fas fa-print"></i></button>
                                    </td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                                ...
                                <ul class="pagination justify-content-center pagination-sm">
                                    <li class="page-item">
                                        ...
                                        <?php else :  ?>
                                            <?php if (isset($_POST['date_debut'])) :  ?>
                                                ...
                                                <form action="<?= base_url('Listeproforma/search/' . ($current - 1)) ?>" method="post">
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href='<?= base_url('Listeproforma/page/' . ($current - 1)) ?>' aria-label="Previous">
                                                    <span aria-hidden="true"><i class="fa-solid fa-angle-left"></i></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    ...
                                    <?php for ($i = 1; $i <= $nPages; $i++) :  ?>
                                        <li class="page-item <?= ($i == $current) ? 'active'  :  '' ?>">
                                            <?php if (isset($_POST['date_debut'])) :  ?>
                                                <form action="<?= base_url('Listeproforma/search/' . ($i)) ?>" method="post">
                                                    <div class="row d-none">
                                                        <div class="col-4 row">
                                                            <label for="date_debut" class="form-label">Date de début : </label>
                                                            <div class="input-group  mb-3">
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href="<?= base_url('Listeproforma/page/' . $i) ?>"><?= $i ?></a>
                                            <?php endif; ?>
                                        </li>
                                    <?php endfor; ?>
                                    ...
                                    <li>
                                        ...
                                        <?php else :  ?>
                                            ...
                                            <?php else :  ?>
                                                <a class="page-link" href="<?= base_url('Listeproforma/page/' . ($current + 1)) ?>" aria-label="Next">
                                                    <span aria-hidden="true"><i class="fa-solid fa-angle-right"></i></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
