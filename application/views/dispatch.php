        ...
        <div class="corps">
            <div class="stock_corps">
                    ...
                    <div id="alertModal" class="modal" style="display: block ; background : #00000045  ">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <!-- Modal Header -->
                                <div class="modal-header">
                                    <h4 class="modal-title dispatch">Produit en cours de rupture de stock </h4>
                                                ...
                                                <tbody>
                                                    <?php foreach ($stock_alerts as $key => $stock_alert) : ?>
                                                        <tr class="table-danger">
                                                            <td><?= $stock_alert->refmateriel ?></td>
                                                            <td><?= $stock_alert->designationmateriel ?></td>
                                                            <td><?= $stock_alert->quantite_texte ?></td>
                ...
                <div>
                    ...
                    <div class="onglet">
                        <a href="<?= base_url('dispatch') ?>" id="panier_" class="onglet_btn active">Nouvel enregistrement</a>
                    ...
                    <?php if ($this->session->flashdata('success')) : ?>
                        <script>
                            Myalert.added('Dispatch effectuée');
                        </script>
                    <?php endif ?>
